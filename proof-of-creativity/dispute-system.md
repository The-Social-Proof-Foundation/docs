...
**Voting Duration**: 7 epochs from dispute submission
**Voting Options**:
...
**Automatic Resolution**: After voting period ends using `resolve_dispute_voting`
**Winning Determination**: Side with higher total stake wins
**Economic Distribution**: Winners share rewards from losing side
...
### Badge Disputes
**Scenario**: Post owner believes their original content should have a PoC badge
**If Overturn Wins**: 
...
**Scenario**: Post owner believes revenue redirection is incorrect
**If Overturn Wins**:
...
### Token Pool Updates
**Automatic Synchronization**: Dispute resolutions trigger token pool updates
**Consistent State**: Token trading respects updated PoC decisions
**Real-time Application**: Changes apply immediately to future transactions
